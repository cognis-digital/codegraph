"""Native cognis-connect emit for codegraph — forward findings to any platform.

Maps codegraph's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    codegraph ... --format json | codegraph-emit --to stix
    codegraph-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
